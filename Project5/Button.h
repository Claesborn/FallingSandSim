...
private:
    ...
    sf::Color idleColor, hoverColor, clickedColor, textIdleColor, textHoverColor, textClickedColor;
...
public:
    MultiButton(sf::Vector2f size, sf::Vector2f position,
        ...
        , textIdleColor(textIdle), textHoverColor(textHover), textClickedColor(textClick)
    {
        button.setSize(size);
...
public:
    Button(sf::Vector2f size, sf::Vector2f position,
        ...
        : state(ButtonState::Idle), idleColor(idleCol), hoverColor(hoverCol), clickedColor(clickCol), onClick(std::move(clickAction)), isActive(isActiveAtStart),
        textIdleColor(textIdle), textHoverColor(textHover), textClickedColor(textClick)
    {
        button.setSize(size);
        button.setPosition(position);
