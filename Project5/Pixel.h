...
struct WaterColor {
	static sf::Color getRandom() {
		uint8_t r = 10 + rand() % 21;    // 10–30 (very dark blue component)
		uint8_t g = 60 + rand() % 31;    // 60–90 (hint of green)
		uint8_t b = 180 + rand() % 51;   // 180–230 (strong blue channel)
		return sf::Color(r, g, b, 200);  // optional alpha for transparency
	}
};
...
struct Pixel
{
	...
	void setState(PixelStatus flag)
	{
		m_flags |= flag;
	}
